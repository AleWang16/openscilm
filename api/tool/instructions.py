...
# prompts = ("Answer the following question related to the recent research in NLP. Your answer should be detailed and informative, and is likely to be more than single sentence. Your answer should be marked as [Response_Start] and [Response_End]. "
# "Your answer must come with citations of existing papers. For each citation-worthy statement, add citation numbers e.g., [1] referring to your citations, and after you generate the answer, list the title of cited papers. "
# "For instance, your output looks like this: "
...
# "References:\n"
# "[0] Attributed Question Answering: Evaluation and Modeling for Attributed Large Language Models\n"
# "[1] Reliable, Adaptable, and Attributable Language Models with Retrieval\n"
...
# "[6] RECOMP: Improving Retrieval-Augmented LMs with Context Compression and Selective Augmentation[Response_End]\n")
# instance_prompts = "\nQuestion: {input}\nAnswer: "
...
#                        "If multiple evidences support the sentence, please add both numbers at the end of the sentences as [1][2]. "
...
# generation_instance_prompts_w_references_zero_shot = ("Answer the following question related to the recent research. Your answer should be detailed and informative, and is likely to be more than one paragraph. "
#                        "Your answer should be horistic, based on multiple evidences and references, rather than a short sentence only based on single referenec."
#                        "Make the answer well-structured, informative so that real-world scientist can get comprehensive overview of the area based on your answer."
#                         "All of citation-worthy statements need to be supported by one of the references we provide as 'References' and appropriate citation numbers should be added at the last of the sentences."
#                        "References: \n{context}"
